...
(function () {
  var k = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
    ...
    var g, h, l;typeof window !== "undefined" && window.navigator && window.document ? h = function (a, b) {
      var c = g.createXhr();c.open("GET", a, !0);c.onreadystatechange = function () {
      ...
      var c = new java.io.File(a),
          ...
          f,
          g = "";try {
        d = new java.lang.StringBuffer();(f = c.readLine()) && f.length() && f.charAt(0) === 65279 && (f = f.substring(1));for (d.append(f); (f = c.readLine()) !== null;) d.append(e), d.append(f);g = String(d.toString());
      } finally {
        c.close();
      }b(g);
    });return g = { version: "0.27.0", strip: function strip(a) {
        if (a) {
          var a = a.replace(n, ""),
              b = a.match(o);b && (a = b[1]);
        } else a = "";return a;
      }, jsEscape: function jsEscape(a) {
        ...
        }if (!a) throw Error("createXhr(): XMLHttpRequest not available");return a;
      }, get: h, parseName: function parseName(a) {
        var b = !1,
            c = a.indexOf("."),
            e = a.substring(0, c),
            a = a.substring(c + 1, a.length),
            c = a.indexOf("!");c !== -1 && (b = a.substring(c + 1, a.length), b = b === "strip", a = a.substring(0, c));return { moduleName: e, ext: a, strip: b };
      }, xdRegExp: /^((\w+)\:)?\/\/([^\/\\]+)/, useXhr: function useXhr(a, b, c, e) {
        var d = g.xdRegExp.exec(a),
            f;if (!d) return !0;a = d[2];d = d[3];d = d.split(":");f = d[1];d = d[0];return (!a || a === b) && (!d || d === c) && (!f && !d || f === e);
      }, finishLoad: function finishLoad(a, b, c, e, d) {
        c = b ? g.strip(c) : c;d.isBuild && d.inlineText && (j[a] = c);e(c);
      }, load: function load(a, b, c, e) {
        var d = g.parseName(a),
            f = d.moduleName + "." + d.ext,
            m = b.toUrl(f),
            h = e && e.text && e.text.useXhr || g.useXhr;!i || h(m, p, q, r) ? g.get(m, function (b) {
          g.finishLoad(a, d.strip, b, c, e);
        }) : b([f], function (a) {
          g.finishLoad(d.moduleName + "." + d.ext, d.strip, a, c, e);
        });
      }, write: function write(a, b, c) {
        if (b in j) {
          var e = g.jsEscape(j[b]);
          c.asModule(a + "!" + b, "define(function () { return '" + e + "';});\n");
        }
      }, writeFile: function writeFile(a, b, c, e, d) {
        var b = g.parseName(b),
            f = b.moduleName + "." + b.ext,
            h = c.toUrl(b.moduleName + "." + b.ext) + ".js";g.load(f, c, function () {
          var b = function b(a) {
            return e(h, a);
